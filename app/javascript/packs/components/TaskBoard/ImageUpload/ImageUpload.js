...
const ImageUpload = ({ onUpload }) => {
  ...
  const [cropParams, changeCropParams] = useState(defaultPropsParams);
  ...
  const onImageLoaded = (loadedImage) => {
    const newCropParams = makeAspectCrop(defaultPropsParams, loadedImage.width, loadedImage.height);
